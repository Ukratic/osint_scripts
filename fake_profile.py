...
# Request to the randomuser API to get a random profile
response = requests.get("https://randomuser.me/api/").json()

# Extracts the necessary information from the response data
...
# Prints the fake profile information in terminal
...
# Outputs fake profile information to a txt file
...
# Downloads the profile picture and save it to a jpg file
